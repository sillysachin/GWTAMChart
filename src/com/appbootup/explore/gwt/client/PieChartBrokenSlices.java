...
import com.amcharts.impl.listener.AmChartEvent;
import com.amcharts.impl.listener.AmChartListener;
import com.amcharts.impl.listener.DataContext;
...
public class PieChartBrokenSlices
{
	...
	protected void simplePieChart( JavaScriptObject chartData )
	{
		...
		amPieChart.addListener( "clickSlice", new AmChartListener()
		{
			@Override
			public void function( AmChartEvent event )
			{
				Integer selected=1;
//				DataContext dataContext = event.getDataItem().getDataContext();
