...
public final class AmGraphJSO extends JavaScriptObject implements IsAmGraph
{
	...
	/**
	 * "If you set some function, the graph will call it and pass GraphDataItem and AmGraph object to it. This function should return this.a string which will be displayed in a balloon."
	 */
	...
	public final native double getBulletBorderThickness() /*-{
		return this.bulletBorderThickness;
	}-*/;
	...
	/**
	 * You can use it to format labels of data items in any way you want. Graph will call this function and pass reference to GraphDataItem and formatted text as attributes. This function should return this.string which will be displayed as label.
	 */
	...
	public final native String getLegendPeriodValueText() /*-{
		return this.legendPeriodValueText;
	}-*/;
	...
	public final native double getNegativeFillAlphas() /*-{
		return this.negativeFillAlphas;
	}-*/;
	...
	public final native String getNegativeFillColors() /*-{
		return this.negativeFillColors;
	}-*/;
	...
	public final native Boolean isShowAllValueLabels() /*-{
		return this.showAllValueLabels;
	}-*/;
	...
	public final native Boolean isUseNegativeColorIfDown() /*-{
		return this.useNegativeColorIfDown;
	}-*/;
